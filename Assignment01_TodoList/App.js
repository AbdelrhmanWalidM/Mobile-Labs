...
export default function App() {
    ...
    function clearCompletedHandler() {
        setCourseGoals((currentCourseGoals) => {
            return currentCourseGoals.filter((goal) => !goal.completed);
        });
    }
                ...
                <FlatList
                    ...
                    renderItem={(itemData) => (
                        ...
                        >
                            <View style={[
                                styles.goalItem,
                                itemData.item.completed && styles.goalItemCompleted
                            ]}>
                                <View style={[
                                    styles.goalDot,
                                    itemData.item.completed && styles.goalDotCompleted
                                ]} />
                                <Text style={[
                                    styles.goalText,
                                    itemData.item.completed && styles.goalTextCompleted
                                ]}>
                                    {itemData.item.text}
                                </Text>
